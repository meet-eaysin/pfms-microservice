...
import { CreateRuleUseCase } from '../../../core/application/use-cases/automation/create-rule.use-case';
import { CreateRuleDto } from '../../../core/application/dto/automation/create-rule.dto';
